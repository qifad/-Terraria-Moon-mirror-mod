...
{
	public class ExampleLifeFruit2 : ModItem
	{
        public const int MaxExampleLifeFruits2 = 10;
        public const int LifePerFruit = 150;


        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault($"Permanently increases maximum life by {LifePerFruit}\nUp to {MaxExampleLifeFruits2} can be used");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return player.statLifeMax >= 500 && player.GetModPlayer<mdplayer>().exampleLifeFruits < MaxExampleLifeFruits2;
        }
