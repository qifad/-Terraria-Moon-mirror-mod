...
namespace tewd.Proj
{
    ...
    public class ExampleSimpleMinionItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("微型破烂战斗机召唤杖");
            Tooltip.SetDefault("可以召唤微型破烂战斗机来为你战斗");
    ...
    public class ExampleSimpleMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else if (State == 1)
            {
                ...
                if (Timer % 12 < 1)
                {
                    var ysxb = Terraria.Projectile.NewProjectileDirect(Projectile.GetSource_FromAI(), Projectile.Center+ Projectile.velocity + diff * 100, diff * 10f, ProjectileID.Bullet,
        ...
        private void MoveAroundPlayer(Player player)
        {
            ...
            // 半径r = 100，线速度v = 10
            var unit = (player.Center - Projectile.Center).SafeNormalize(Vector2.Zero) * 20 * 20 / 500f;
